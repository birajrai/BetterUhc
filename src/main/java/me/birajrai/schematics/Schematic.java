...
public class Schematic {
    ...
    public static File getSchematicFile(String name){
        File schematic = new File(BetterUhc.getPlugin().getDataFolder(),name+".schematic");
        if (schematic.exists()) return schematic;
        schematic = new File(BetterUhc.getPlugin().getDataFolder(),name+".schem");
        return schematic;
    }

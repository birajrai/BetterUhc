...
public class VaultManager {
	...
	public static void addMoney(final Player player, final double amount){
		...
		Bukkit.getScheduler().runTaskAsynchronously(BetterUhc.getPlugin(), () -> economy.depositPlayer(offlinePlayer, amount));
	}
	...
	public static void removeMoney(final Player player, final double amount){
		...
		Bukkit.getScheduler().runTaskAsynchronously(BetterUhc.getPlugin(), () -> economy.withdrawPlayer(player, amount));
	}

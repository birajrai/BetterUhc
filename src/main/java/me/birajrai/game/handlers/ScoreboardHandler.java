...
import me.birajrai.threads.UpdateScoreboardThread;
...
public class ScoreboardHandler {
    ...
    public void setUpPlayerScoreboard(UhcPlayer uhcPlayer, Player bukkitPlayer) {
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(BetterUhc.getPlugin(),new UpdateScoreboardThread(this, uhcPlayer),1L);
    }

...
public class FastSmeltingListener extends ScenarioListener{
    ...
    public void onFurnaceBurn(FurnaceBurnEvent e){
        ...
        Bukkit.getScheduler().runTaskLater(BetterUhc.getPlugin(), new Runnable() {
            @Override
            public void run() {
                ...
                if (furnace.getCookTime() <= 0){
                    Bukkit.getScheduler().runTaskLater(BetterUhc.getPlugin(), this, 5);
                    return;
                }
                ...
                furnace.update();
                Bukkit.getScheduler().runTaskLater(BetterUhc.getPlugin(), this, 2);
            }
        }, 1);
    }

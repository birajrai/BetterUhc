...
import me.birajrai.utils.MojangUtils;
...
public class ReviveCommandExecutor implements CommandExecutor{
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(BetterUhc.getPlugin(), () -> uuidCallback(MojangUtils.getPlayerUuid(name), MojangUtils.getPlayerName(name), spawnWithItems, sender));
        return true;
    }
    ...
    private void uuidCallback(UUID uuid, String name, boolean spawnWithItems, CommandSender caller){
        if (!Bukkit.isPrimaryThread()){
            ...
            Bukkit.getScheduler().runTask(BetterUhc.getPlugin(), () -> uuidCallback(uuid, name, spawnWithItems, caller));
            return;
        }

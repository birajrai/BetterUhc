...
public class ProtocolUtils{
    ...
    private ProtocolUtils(){
        ...
        ProtocolLibrary.getProtocolManager().addPacketListener(new PacketAdapter(BetterUhc.getPlugin(), PacketType.Play.Server.PLAYER_INFO) {
    ...
    public static void register(){
        if (protocolUtils != null){
            ProtocolLibrary.getProtocolManager().removePacketListeners(BetterUhc.getPlugin());
            protocolUtils = null;
        }
    ...
    private static void updatePlayer(Player player){
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(BetterUhc.getPlugin(), () -> {
            for (Player all : player.getWorld().getPlayers()){

...
public class Lang{
	...
	private void loadLangConfig() {
		File langFile = new File(BetterUhc.getPlugin().getDataFolder(),"lang.yml");
		if(!langFile.exists()) {
			try {
		...
		try{
			lang = FileUtils.saveResourceIfNotAvailable(BetterUhc.getPlugin(), "lang.yml");
